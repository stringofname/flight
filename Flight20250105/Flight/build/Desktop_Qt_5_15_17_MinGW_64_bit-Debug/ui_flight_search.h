...
public:
    ...
    void setupUi(QWidget *flight_search)
    {
        ...
        labelBackground->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix1/bgground2.png);"));
        labelTitle = new QLabel(flight_search);
        labelTitle->setObjectName(QString::fromUtf8("labelTitle"));
        labelTitle->setGeometry(QRect(390, 50, 121, 30));
        QFont font;
        ...
        labelTakeoff->setGeometry(QRect(120, 150, 80, 20));
        QFont font1;
        font1.setPointSize(14);
        labelTakeoff->setFont(font1);
        labelTakeoff->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        lineEditChu = new QLineEdit(flight_search);
        lineEditChu->setObjectName(QString::fromUtf8("lineEditChu"));
        lineEditChu->setGeometry(QRect(210, 150, 120, 30));
        ...
        labelArrival->setGeometry(QRect(370, 150, 80, 20));
        labelArrival->setFont(font1);
        labelArrival->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        lineEditDao = new QLineEdit(flight_search);
        lineEditDao->setObjectName(QString::fromUtf8("lineEditDao"));
        lineEditDao->setGeometry(QRect(460, 150, 120, 30));
        ...
        labelDate->setGeometry(QRect(630, 150, 80, 20));
        ...
        lineEditDate->setGeometry(QRect(720, 150, 120, 30));
        ...
        pushButton->setGeometry(QRect(400, 200, 100, 40));
        QFont font2;
...
"    "));
        ...
        tableWidget->setGeometry(QRect(50, 270, 800, 300));
