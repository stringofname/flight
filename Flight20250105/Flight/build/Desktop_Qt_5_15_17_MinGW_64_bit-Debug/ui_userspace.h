...
public:
    ...
    void setupUi(QWidget *userspace)
    {
        ...
        ReturnButtn->setStyleSheet(QString::fromUtf8("QPushButton { background-color: none; border-radius: 3px; color: black; } \n"
...
""));
        ...
        labelSet1->setGeometry(QRect(290, 81, 261, 21));
        QFont font1;
        font1.setFamily(QString::fromUtf8("\345\271\274\345\234\206"));
        font1.setPointSize(16);
        font1.setBold(true);
        labelSet1->setFont(font1);
        labelSet1->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        labelSet2 = new QLabel(userspace);
        labelSet2->setObjectName(QString::fromUtf8("labelSet2"));
        labelSet2->setGeometry(QRect(290, 121, 261, 21));
        labelSet2->setFont(font1);
        labelSet2->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        labelName = new QLabel(userspace);
        labelName->setObjectName(QString::fromUtf8("labelName"));
        labelName->setGeometry(QRect(230, 80, 71, 21));
        labelName->setFont(font1);
        labelName->setAlignment(Qt::AlignCenter);
        labelAccount = new QLabel(userspace);
        labelAccount->setObjectName(QString::fromUtf8("labelAccount"));
        labelAccount->setGeometry(QRect(230, 120, 71, 21));
    ...
    void retranslateUi(QWidget *userspace)
    {
        ...
        ReturnButtn->setText(QCoreApplication::translate("userspace", "<-\350\277\224\345\233\236", nullptr));
