...
public:
    ...
    void setupUi(QWidget *flight_delete)
    {
        ...
        label_2->setGeometry(QRect(230, 140, 71, 31));
        QFont font;
        ...
        label_3->setGeometry(QRect(300, 180, 191, 16));
        lineEdit = new QLineEdit(flight_delete);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(300, 140, 121, 31));
        QFont font1;
...
""));
        ...
        pushButton->setGeometry(QRect(440, 140, 75, 31));
