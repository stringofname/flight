...
public:
    ...
    void setupUi(QWidget *flight_add)
    {
        if (flight_add->objectName().isEmpty())
            flight_add->setObjectName("flight_add");
...
"}"));
        ...
        widget = new QWidget(flight_add);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(50, 450, 93, 22));
    ...
    void retranslateUi(QWidget *flight_add)
    {
        ...
        label_6->setText(QCoreApplication::translate("flight_add", "\350\266\205\347\272\247\347\273\217\346\265\216\350\210\261", nullptr));
        label_8->setText(QCoreApplication::translate("flight_add", "\345\244\264\347\255\211\344\273\223", nullptr));
