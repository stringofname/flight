...
public:
    ...
    void setupUi(QWidget *zhuce_govern)
    {
        ...
        layoutWidget->setGeometry(QRect(70, 160, 201, 211));
        ...
        pushButton->setMinimumSize(QSize(95, 23));
        pushButton->setMaximumSize(QSize(95, 23));
        ...
        pushButton_2->setMinimumSize(QSize(95, 23));
        pushButton_2->setMaximumSize(QSize(95, 23));
