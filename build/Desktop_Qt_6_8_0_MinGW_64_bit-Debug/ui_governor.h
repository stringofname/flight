...
public:
    ...
    void setupUi(QWidget *governor)
    {
        if (governor->objectName().isEmpty())
            governor->setObjectName("governor");
        governor->resize(364, 317);
        layoutWidget = new QWidget(governor);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(0, 0, 361, 313));
        ...
        btnSereach->setObjectName("btnSereach");
