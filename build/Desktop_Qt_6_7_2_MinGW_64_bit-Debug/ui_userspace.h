...
public:
    ...
    void setupUi(QWidget *userspace)
    {
        ...
        tableTickets->setGeometry(QRect(0, 160, 801, 341));
        tableTickets->setRowCount(0);
        tableTickets->setColumnCount(6);
        ReturnButtn = new QPushButton(userspace);
        ReturnButtn->setObjectName("ReturnButtn");
...
"}"));
        ...
        labelSet1->setObjectName("labelSet1");
        ...
        labelSet2->setObjectName("labelSet2");
        ...
        label->setGeometry(QRect(-10, -10, 811, 171));
...
"background-image: url(:/Imageres/airBg.jpeg);"));
    ...
    {
        userspace->setWindowTitle(QCoreApplication::translate("userspace", "\344\270\252\344\272\272", nullptr));
