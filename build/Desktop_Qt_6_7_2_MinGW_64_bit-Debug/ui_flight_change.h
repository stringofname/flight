...
public:
    ...
    void setupUi(QWidget *flight_change)
    {
        if (flight_change->objectName().isEmpty())
            flight_change->setObjectName("flight_change");
        flight_change->resize(695, 448);
        flight_change->setStyleSheet(QString::fromUtf8("#flight_change{background-image: url(:/Imageres/airBg.jpeg);}"));
        ...
        arrivalCity->setObjectName("arrivalCity");
...
""));
        ...
        firstPrice->setObjectName("firstPrice");
...
""));
        ...
        flightDate->setObjectName("flightDate");
...
""));
        ...
        businessNum->setObjectName("businessNum");
...
""));
        ...
        economyPrice->setObjectName("economyPrice");
...
""));
        ...
        economyNum->setObjectName("economyNum");
        economyNum->setGeometry(QRect(150, 380, 71, 23));
        economyNum->setFont(font1);
        economyNum->setStyleSheet(QString::fromUtf8("border:none;border: 1px solid gray; border-radius: 5px; padding: 2px;\n"
""));
        ...
        takeoffCity->setObjectName("takeoffCity");
        ...
        businessPrice->setObjectName("businessPrice");
...
""));
        ...
        frame->setStyleSheet(QString::fromUtf8("#flight_add{background-image: url(:/Image/Imageres/Bookings.jpg);}"));
...
"}"));
    ...
    {
        flight_change->setWindowTitle(QCoreApplication::translate("flight_change", "\344\277\256\346\224\271\350\210\252\347\217\255", nullptr));
