...
public:
    ...
    void setupUi(QWidget *book)
    {
        ...
        label_7->setGeometry(QRect(70, 310, 91, 31));
        label_7->setFont(font);
        label_8 = new QLabel(book);
        label_8->setObjectName("label_8");
        label_8->setGeometry(QRect(50, 370, 91, 31));
        ...
        comboBox->setGeometry(QRect(450, 311, 151, 31));
        comboBox->setStyleSheet(QString::fromUtf8("background-color: rgb(253, 253, 253);"));
        label_9 = new QLabel(book);
        label_9->setObjectName("label_9");
        label_9->setGeometry(QRect(370, 310, 91, 31));
        label_9->setFont(font);
        label_10 = new QLabel(book);
        label_10->setObjectName("label_10");
        label_10->setGeometry(QRect(370, 370, 91, 31));
        label_10->setFont(font);
        lineEditDepartTime = new QLineEdit(book);
        lineEditDepartTime->setObjectName("lineEditDepartTime");
        lineEditDepartTime->setGeometry(QRect(540, 70, 141, 31));
        lineEditDepartTime->setStyleSheet(QString::fromUtf8("border: 1px solid gray; border-radius: 5px; padding: 2px;"));
        ...
        lineEditArrivalTime->setObjectName("lineEditArrivalTime");
        lineEditArrivalTime->setGeometry(QRect(540, 130, 141, 31));
        lineEditArrivalTime->setStyleSheet(QString::fromUtf8("border: 1px solid gray; border-radius: 5px; padding: 2px;"));
        ...
        lineEditName->setGeometry(QRect(150, 310, 191, 31));
        ...
        lineEdit_8->setGeometry(QRect(150, 370, 191, 31));
        lineEdit_8->setStyleSheet(QString::fromUtf8("border: 1px solid gray; border-radius: 5px; padding: 2px;"));
        lineEditPrice_1 = new QLineEdit(book);
        lineEditPrice_1->setObjectName("lineEditPrice_1");
        lineEditPrice_1->setGeometry(QRect(460, 370, 81, 31));
        lineEditPrice_1->setStyleSheet(QString::fromUtf8("border: 1px solid gray; border-radius: 5px; padding: 2px;"));
        lineEditPrice_2 = new QLineEdit(book);
        lineEditPrice_2->setObjectName("lineEditPrice_2");
        lineEditPrice_2->setGeometry(QRect(570, 370, 81, 31));
        lineEditPrice_2->setStyleSheet(QString::fromUtf8("border: 1px solid gray; border-radius: 5px; padding: 2px;"));
        lineEditPrice_3 = new QLineEdit(book);
        lineEditPrice_3->setObjectName("lineEditPrice_3");
        lineEditPrice_3->setGeometry(QRect(680, 370, 81, 31));
        lineEditPrice_3->setStyleSheet(QString::fromUtf8("border: 1px solid gray; border-radius: 5px; padding: 2px;"));
...
"}"));
        ...
        lineEditFlightNum->setObjectName("lineEditFlightNum");
        lineEditFlightNum->setGeometry(QRect(540, 190, 141, 31));
        lineEditFlightNum->setStyleSheet(QString::fromUtf8("border: 1px solid gray; border-radius: 5px; padding: 2px;"));
        pushButton = new QPushButton(book);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(650, 310, 111, 31));
        QFont font1;
...
""));
        ...
        label_11->setGeometry(QRect(-10, -20, 921, 521));
        label_11->setStyleSheet(QString::fromUtf8("background-image: url(:/Imageres/airBg.jpeg);"));
        label_11->raise();
        label_2->raise();
        label_3->raise();
        label_4->raise();
    ...
    {
        book->setWindowTitle(QCoreApplication::translate("book", "\350\256\242\347\245\250", nullptr));
